...
public:
    CMainParams() {
        ...
        consensus.Hardfork3.Initialize(3 /* Hardfork ID */, 1577379600 /* Hardfork Activation Time */, 999999 /* Hardfork Activation Height - unknown yet*/, uint256() /* Hardfork Activation Blockhash - unknown yet*/);
        ...
        consensus.aPOWAlgos[ALGO_X11]             = CPOWAlgoProperties(ALGO_X11, uint256S("00000fffff000000000000000000000000000000000000000000000000000000"));
        consensus.aPOWAlgos[ALGO_NEOSCRYPT]       = CPOWAlgoProperties(ALGO_NEOSCRYPT, uint256S("00001fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_EQUIHASH]        = CPOWAlgoProperties(ALGO_EQUIHASH, uint256S("0007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT]        = CPOWAlgoProperties(ALGO_YESCRYPT, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HMQ1725]         = CPOWAlgoProperties(ALGO_HMQ1725, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_XEVAN]           = CPOWAlgoProperties(ALGO_XEVAN, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_NIST5]           = CPOWAlgoProperties(ALGO_NIST5, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_TIMETRAVEL10]    = CPOWAlgoProperties(ALGO_TIMETRAVEL10, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PAWELHASH]       = CPOWAlgoProperties(ALGO_PAWELHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X13]             = CPOWAlgoProperties(ALGO_X13, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X14]             = CPOWAlgoProperties(ALGO_X14, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X15]             = CPOWAlgoProperties(ALGO_X15, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X17]             = CPOWAlgoProperties(ALGO_X17, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2REV2]       = CPOWAlgoProperties(ALGO_LYRA2REV2, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_BLAKE2S]         = CPOWAlgoProperties(ALGO_BLAKE2S, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_BLAKE2B]         = CPOWAlgoProperties(ALGO_BLAKE2B, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ASTRALHASH]      = CPOWAlgoProperties(ALGO_ASTRALHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PADIHASH]        = CPOWAlgoProperties(ALGO_PADIHASH, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_JEONGHASH]       = CPOWAlgoProperties(ALGO_JEONGHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ZHASH]           = CPOWAlgoProperties(ALGO_ZHASH, uint256S("0007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_KECCAKC]         = CPOWAlgoProperties(ALGO_KECCAKC, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_GLOBALHASH]      = CPOWAlgoProperties(ALGO_GLOBALHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_QUBIT]           = CPOWAlgoProperties(ALGO_QUBIT, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SKEIN]           = CPOWAlgoProperties(ALGO_SKEIN, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_GROESTL]         = CPOWAlgoProperties(ALGO_GROESTL, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SKUNKHASH]       = CPOWAlgoProperties(ALGO_SKUNKHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_QUARK]           = CPOWAlgoProperties(ALGO_QUARK, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X16R]            = CPOWAlgoProperties(ALGO_X16R, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2REV3]       = CPOWAlgoProperties(ALGO_LYRA2REV3, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R16V2]  = CPOWAlgoProperties(ALGO_YESCRYPT_R16V2, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R24]    = CPOWAlgoProperties(ALGO_YESCRYPT_R24, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R8]     = CPOWAlgoProperties(ALGO_YESCRYPT_R8, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R32]    = CPOWAlgoProperties(ALGO_YESCRYPT_R32, uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X25X]            = CPOWAlgoProperties(ALGO_X25X, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARGON2D]         = CPOWAlgoProperties(ALGO_ARGON2D, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARGON2I]         = CPOWAlgoProperties(ALGO_ARGON2I, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_CPU23R]          = CPOWAlgoProperties(ALGO_CPU23R, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESPOWER]        = CPOWAlgoProperties(ALGO_YESPOWER, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X21S]            = CPOWAlgoProperties(ALGO_X21S, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X16S]            = CPOWAlgoProperties(ALGO_X16S, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X22I]            = CPOWAlgoProperties(ALGO_X22I, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2Z]          = CPOWAlgoProperties(ALGO_LYRA2Z, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HONEYCOMB]       = CPOWAlgoProperties(ALGO_HONEYCOMB, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_EH192]           = CPOWAlgoProperties(ALGO_EH192, uint256S("0007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_MARS]            = CPOWAlgoProperties(ALGO_MARS, uint256S("0007ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X12]             = CPOWAlgoProperties(ALGO_X12, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HEX]             = CPOWAlgoProperties(ALGO_HEX, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_DEDAL]           = CPOWAlgoProperties(ALGO_DEDAL, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_C11]             = CPOWAlgoProperties(ALGO_C11, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PHI1612]         = CPOWAlgoProperties(ALGO_PHI1612, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_PHI2]            = CPOWAlgoProperties(ALGO_PHI2, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_X16RT]           = CPOWAlgoProperties(ALGO_X16RT, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_TRIBUS]          = CPOWAlgoProperties(ALGO_TRIBUS, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_ALLIUM]          = CPOWAlgoProperties(ALGO_ALLIUM, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARCTICHASH]      = CPOWAlgoProperties(ALGO_ARCTICHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_DESERTHASH]      = CPOWAlgoProperties(ALGO_DESERTHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_CRYPTOANDCOFFEE] = CPOWAlgoProperties(ALGO_CRYPTOANDCOFFEE, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_RICKHASH]        = CPOWAlgoProperties(ALGO_RICKHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        ...
        */
        ...
        vFoundersRewardAddress = {
            ...
            "3PFZ1oudGLkWg7kkV9qgosseuYsrhJd6ou", /* main-index: 15*/
            "34EBnTUYk3kzhwn6oNni1eyQ83vap4iVxZ", /* main-index: 16*/
            "37hNzkCuYGiVxP2AuMEmrBWQem4NQVUcJD", /* main-index: 17*/
            "35eZ5UFfdb5687GTdAK29hthEyzuXNcbcv", /* main-index: 18*/
            "37bUB14wvftu2c5mhgQbDh55rTDrGZQo4s", /* main-index: 19*/
            "38Xr5NCzbyJ1LJsouj2qNiuebyS4tNpwMJ", /* main-index: 20*/
            "3LpGTXpTi6aTTNsUyP58JwTSMyVYN2WBAd", /* main-index: 21*/
            "3NUuqPCcsPq66DQzD235pQGKTDyYg5zu93", /* main-index: 22*/
            "3DbSjJiJrVHpWEkhtPGtrdL73KFZRxmxuY", /* main-index: 23*/
            "33MnpZW33r5AUaQmxaTHpnV8KRVTTokC5p", /* main-index: 24*/
            "3HpDAy9591ykTcswgNKzPEBttc2cbMicdu", /* main-index: 25*/
            "3BmCBFZGwBNmEjL5hYW8ptQdU9pLKeQ8h3", /* main-index: 26*/
            "3Gm2qwZ8d26er6iLqFD3MQpwwNcbxQDnqW", /* main-index: 27*/
            "3LDQzQ5FguS8GiyDNgzSGz5oxHacoFYmTg", /* main-index: 28*/
            "3QMu3phWfKuM3Y5qTPjrexKBCDp1mU71JP", /* main-index: 29*/
            "35sHQwj5XRXMSqiiPhFipuifaKKUJSpbqS", /* main-index: 30*/
            "3NXRgZLxLjfFuBhrMHyMrjbJ2U83bChY1K", /* main-index: 31*/
            "3MjcgCvwtA2hkFKmVYhhfB3xvDASWpCPq4", /* main-index: 32*/
            "3L6zcGQii1Agabk37GFRPzMF6n9L9SsubM", /* main-index: 33*/
            "3QRa51mmERnT9voP9xq9sbpxmjAs1XWgqy", /* main-index: 34*/
            "39RnxJpsjRqgMyVd4Rg1gu1KyJHcQVsxTW", /* main-index: 35*/
            "373wRiUZ5DWCnGYp6Qf9hJU7K8LE5XT69h", /* main-index: 36*/
            "39QNaNjyrs6Jx5wxyZyaF7trXqRzAqYsKq", /* main-index: 37*/
            "3AdstaMFw2XEJCTQt8C5VE9dfDiLNs5TTC", /* main-index: 38*/
            "33SKqqm2eQ3yZd51L5SSKVJwNaG72ZW2xv", /* main-index: 39*/
            "3GMJ9wm8J7rHmAFkV4r7G3syr3ieK6ogZd", /* main-index: 40*/
            "3JekMeXUX156Tzf2itjpNzvJAQAU2YGn4q", /* main-index: 41*/
            "3EAkDi4uGhQML1XgjZQPPsVXHfGshSrfZc", /* main-index: 42*/
            "33QXMVBT7ChcHAjNHSzG71BSgrmmBxo6sH", /* main-index: 43*/
            "3DCmFMrw5PGAPcUbqbYoCKCpmBMyRvCpZA", /* main-index: 44*/
            "32mFdQSLFrM4fkUeFi4qWU1aim8ZPL36FL", /* main-index: 45*/
            "3FX9wE8aKQhHTMrWyqHEB7hKsGukEazvkW", /* main-index: 46*/
            "38rqrKRmVwgbeiz2zx6RVpPQqb4Xskx7zA", /* main-index: 47*/
            "3Mo2sPeDnfWTLRaNNom8Dcm9WMxRz3qYw3", /* main-index: 48*/
            "3LfpQbQRjRsHozwriAwsRBtvH2wLRJVtN4", /* main-index: 49*/
            "3Hq1SeTKqLdSLBNPo6JYBj4X7Ce7tAee9Q", /* main-index: 50*/
            "36V9JMDw1UBzwvmpvctG5DzfB6QhfsEA5g", /* main-index: 51*/
            "37Bf7wZju2JPvufDNDhoK64CjuCWhDkXoi", /* main-index: 52*/
            "36yU1RMzDnn9RYDqtxBvuiysH2UzXMVRRG", /* main-index: 53*/
            "34F9MmqFATfkHffTbh3hMze8itvpRZ1WHf", /* main-index: 54*/
            "3J15bzgdCjEJ5AiaAu6bbeYTvVP631F5Sd", /* main-index: 55*/
            "3NLZZ5aMd8ECQuKjyYBTtJT9XCavKYj4x2", /* main-index: 56*/
            "38SDhMU2h1z72h7kf1JMVWMoRbTRMDf4qD", /* main-index: 57*/
            "3Ft4BdrgT89yb4HU7mg4zdUtDsFJDrE2bg", /* main-index: 58*/
            "3NUjF1nqsSKsAHfD61Bu5AyTepH4jaeny1", /* main-index: 59*/
            "34Y8HjpExiR4snTM4pezn1s5MSiqyvWJwG", /* main-index: 60*/
            "336xErmdsAG8fckmWQ8dhCGjvjzLSmvXQK", /* main-index: 61*/
            "3LzwXBrDEUHaWU5ypz3MhKvwzUYopP3iML", /* main-index: 62*/
            "3CFqWmqXc6C4k5HU7W4cQH5E8pGsXkPMXH", /* main-index: 63*/
            "37irAKWm8wHRMxGCpo6VQHhaPV8d9CSyTV", /* main-index: 64*/
            "33zVmA7kqNy5ZsywXDYRDFuxY3ZJ2Q9UTX", /* main-index: 65*/
            "38FjYkPW6wpm5Vrw5pS8AQ9Jcbm16oT7ru", /* main-index: 66*/
            "36G3vR74nV3dXBhxgEGuSarGVMCMojnVCf", /* main-index: 67*/
            "3MKxQuvvCixyM5a27ERNTGEhUij88hscfe", /* main-index: 68*/
            "3KSsWWKaK3XiN7aS6dfRw7W6Ef1KxxnZkr", /* main-index: 69*/
            "3GVgdLd8XnWpEpGzfuiqkfcDfSEq6LHtzJ", /* main-index: 70*/
            "3N3w8v82mCF84Wu45Z3zvJJ4EpvrJB71Uv", /* main-index: 71*/
            "3D8gswKQTky51SZMDcmGjDohve8N9RH72B", /* main-index: 72*/
            "3CtjcQrKQC5j66eUy2E5ymGAhtoRfMjmr5", /* main-index: 73*/
            "3GYCnw2iTB1dWz4Z2Z7CGXg95owRHn82Pv", /* main-index: 74*/
            "3F5SdCzkRqhJsv3AZP4xV64vunNbMbMUuG", /* main-index: 75*/
            "3E7dHx6woKaGGXDCwodM8QVR7enYNMFyne", /* main-index: 76*/
            "3MzPTBgAfURb2BsySjwyLBa5n2rtX74LCp", /* main-index: 77*/
            "3CZQi1e25Tw6QZFcgy6qmcdBC8JPyyheJA", /* main-index: 78*/
            "3LHWbo1XQsnRWbUGRLo7NMtXoLhAXUdQDM", /* main-index: 79*/
            "38JMwNmtak2oPxMy8u665i7eRCRKYfLtwS", /* main-index: 80*/
            "3NfVcpwGu4vKFTEEc6XtTSGGkXaZphwsiW", /* main-index: 81*/
            "3PZhXT5afY4m8UzGhS6wuXgTsXHvGXAhEL", /* main-index: 82*/
            "31nKyg493rhMLrZxcKrzizSZTV1qBs1VnQ", /* main-index: 83*/
            "375HCkSJisQofpEneriuJDkbt97fd7oJVU", /* main-index: 84*/
            "32trHnakrEDMp7xf91tMNPwB88L47GQ3Jg", /* main-index: 85*/
            "3LzeWEYdVBafjHddMQbzFBTVZBjfVS926H", /* main-index: 86*/
            "36veTRcKaBQuFmzYABWQoQq5XXsFkRgWaX", /* main-index: 87*/
            "3PfrFds2bBjswYAWBztumZbVz8Y2gekgNu", /* main-index: 88*/
            "33XAjHXXhQSGKScXNqmEyJsmDGC9hFFTek", /* main-index: 89*/
            "3KEqMwV4zPcNREK2oMP6E9qKrrexKLd2Tp", /* main-index: 90*/
            "3B32oQkvkeCNA219T6ttVig6HxudHkqqeC", /* main-index: 91*/
            "37iH8TGH8pCQ4vUQ5t2whNZ22nhAv5bZac", /* main-index: 92*/
            "35Z9pCN6R5x8SEgMuBxCya8VYpZbHQ7Ra4", /* main-index: 93*/
            "3P1AGz15cQEj55cmE2kvhqaVUCCxR5LiAn", /* main-index: 94*/
            "3Ff1b5PBx1nWcXJnXPqBeGLmZvnHfpN5Jp", /* main-index: 95*/
            "32FBSE2RhWuGmASt5M1hsJHCCpTmQKnNsw", /* main-index: 96*/
            "3GNp5VfjvzKEyF4bhEqtRDfng7LVkj8fMf", /* main-index: 97*/
            "3DHuLMn7iXKUqYFSnMx8wambSN5nZLDy9F", /* main-index: 98*/
            "3Kt2iYY2Ujst29pwer4wYskaRDhVQ7vEsj", /* main-index: 99*/
            "3JfspqpmJvKa8jxv17RGuei3LgKAYZeQKm", /* main-index: 100*/
            "3NTiXYwM29SN1sYuRTV1KbPhG7jxwNWdo8", /* main-index: 101*/
            "3Pyn2vtC7ENYbQJCich9eixAXoLUPP9VVL", /* main-index: 102*/
            "3LCVYJfakAWb7uVzDmh35HxZaZMEdGtqE7", /* main-index: 103*/
            "3MkjEJpNs6raj5YyeZ5NjkmZZAnCSf5RUo", /* main-index: 104*/
            "3QUfD1upYLwXNSbvbc2ZwQhpGooCpN67nw", /* main-index: 105*/
            "3B5EWNUb8aTbztYn5VweMJjYh82EKiw3NN", /* main-index: 106*/
            "3QkgSVDCFtGUKXqSHmJkvoJJTSGYPuKsiT", /* main-index: 107*/
            "3NtpMQftrj5NFY49m42QR699ph7uXdYdKs", /* main-index: 108*/
            "3P2FjKAq4P8wvFY64354wbjXyngfAkfcfE", /* main-index: 109*/
            "38TtbsrtDyxCa16FbKDXSvPYsaPKaC54Zw", /* main-index: 110*/
            "3BXBYeZsLdztGHJTLyyyAewriMSeM529GN", /* main-index: 111*/
            "3R2UnNnYkfFCsSe4tfguwMgxZR7p76tef8", /* main-index: 112*/
            "3CRxYmcyRgs54g6PRhrQPWnda6qPuhTVwW", /* main-index: 113*/
            "3NqKS177B8yniKTdE3bnAZRiTE6QuWUrDq", /* main-index: 114*/
            "3LD9T3zZsZAfHKosT6fHomhgqL1Rcmzetu", /* main-index: 115*/
            "3Fcmd1Z9uwJa1hUs2H7PpPb8PcgvFG3Lwf", /* main-index: 116*/
            "3MYmT97nVhCPyV1jK3rzEcwuzUdWE6j7pC", /* main-index: 117*/
            "36Q6d3FCdcUvfri26cTmx6DomT1SGWMv7V", /* main-index: 118*/
            "34fWxLeGy1rPYCP8EX2V84uTo99iv7PBf8", /* main-index: 119*/
            "34gAdue4wjGU38j2NLtqrchPbtbRdGnnj8", /* main-index: 120*/
            "3QnuyuFcfMjfWYMQkdcrNEmuupqBWE43A6", /* main-index: 121*/
            "35xZdSqFbNxyFG5CH1UtHpxtZdJraATUac", /* main-index: 122*/
            "327VsBYqw7nKn7bQe7vBDvAvkqGuPTBvRf", /* main-index: 123*/
            "3Gz5JCEAdoRzLQ4x3Mki9VuFJ5iWgMvJqM", /* main-index: 124*/
            "3MRKgkhjtLepNAmMdzVZoRY66KC9DQh5SR", /* main-index: 125*/
            "3M8U8SMaANXgRsqHRw8D7PDYnxfjaPatu5", /* main-index: 126*/
            "3CPkwFYp3Nv8G4fFmMpxjp7ZDUHvUNgVtR", /* main-index: 127*/
            "38kCS1cEHGV7shQonScjA9REFE88Xk8Poq", /* main-index: 128*/
            "3AdMio1L9GkFxNm25N7tzc9GL2a3akhLwg", /* main-index: 129*/
            "3EZDNuhf9e4jT5txxrYwEivupvq26oZTVC", /* main-index: 130*/
            "3PUnYwwDQqqbWduDk8RusM6UVMZfR7uydw", /* main-index: 131*/
            "32LhJjEgUaLMCsr9awopBYpkb2buRLUNJA", /* main-index: 132*/
            "3Q87bZLS8rGhdns5e7PU7in43gzCtdqqxp", /* main-index: 133*/
            "3GkNnmj2uaCvJgXLfcByboHMzAAzuMug9j", /* main-index: 134*/
            "3KghqCpYbvVuZnSMDYWJ2iTEemNMZLVk99", /* main-index: 135*/
            "35yQVs2mxuGzwmDWkEmJnZbzui3gE97vd6", /* main-index: 136*/
            "3C8fEzaQez9LbXTvkrnPyQhtv42tT1u6Jg", /* main-index: 137*/
            "3KzGQ318dwDy4seHvERBaWzB4Mwe6rz4jM", /* main-index: 138*/
            "36sYYKBT3hzbSMMDatr26iNTseiNx2NBA9", /* main-index: 139*/
            "37UBBLqfZFEAYtTXBdb2Zmn3TVj4iXa4KG", /* main-index: 140*/
            "3CEmppDduSBCupN5oGCsXr7qhWE74nmH3K", /* main-index: 141*/
            "3K42gh3pUDtkCGSt1ZXmmEt4tu1xo19e7K", /* main-index: 142*/
            "339pSdqFQegx7E7Z7CVtna1DQMPfc2bu6S", /* main-index: 143*/
            "352xrPMNAHXqbS8K2Pt1yPvYm6y3NZHSpt", /* main-index: 144*/
            "3QzcsuMSm8QNpNW4fRC1W5UsN5W4ZnGEsC", /* main-index: 145*/
            "3QyJA8vS1oJVPEzPhbah1KpDBEtWEgkLdb", /* main-index: 146*/
            "35Twiyhrer1w78wSt1hT2HwgqMXkr2STb5", /* main-index: 147*/
            "3MX8G7CwTrZuzWpzC7CSdryA9tbSbKyg52", /* main-index: 148*/
            "3AQ4GwPn8UVTix52XpNArGssctSZjYhFXQ", /* main-index: 149*/
            "36NYWYzaETPF9qt6gEM8QW6bVzK4TT5duj", /* main-index: 150*/
            "3Q8kDeGrnCRhxwPHvk6Wy2M2joScKqAAoM", /* main-index: 151*/
            "3QrTVzA4MYZcvVABrZtWD71CdkkChZYyFn", /* main-index: 152*/
            "3FgH71NP6ZkYjrKB8eEAZxEzidDxpekLPx", /* main-index: 153*/
            "3McqZ9r4PBErSJgbhVPRhoHwg5sPmQErzV", /* main-index: 154*/
            "33DQx8iB9RgvqS7ekXMWuaZjrC28RQTrTR", /* main-index: 155*/
            "32A3GmN3FPgxXSnGv93aMrKTsH1ZUt6J1s", /* main-index: 156*/
            "3DA61HhbJR1Kuuk2AA99ToKRecNG7ojqBf", /* main-index: 157*/
            "3ECMvfpT3MREQPckbv61t9xCBRA5Y1xJdQ", /* main-index: 158*/
            "36catUTZcgS23swgjh1AeDcDC7ancRJnm8", /* main-index: 159*/
            "3EyxzsG66NkXKmUWs3n3WcbarwoShbvJ5r", /* main-index: 160*/
            "3HcHkdhMM1AEMc79aWVw92YVMHwv5aLDsP", /* main-index: 161*/
            "3P2XqLodgkvdgoXqKwa6Ge69hdFq92bVQ7", /* main-index: 162*/
            "3EkgzCSmeUDtamedhgbVooHDyKhgj43QXW", /* main-index: 163*/
            "3MvzDkWopJ3Vh5i7KiiZDwbowVJEa8NZrh", /* main-index: 164*/
            "34BSQn3jZwUr8VK7bkkFGQxsw4Vv7tkgf3", /* main-index: 165*/
            "3Htvtz2rFKRkAqabPgaiRyLbnajjegqWin", /* main-index: 166*/
            "3CYxb4SzypvwzjtvuhbHibf1ZmZ6EYSjCx", /* main-index: 167*/
            "3PxcP5rEKdH4tNPdN3UiJCuTPHZXW9MXij", /* main-index: 168*/
            "3EsJDBYSZCnaB9v1hDeqPckqeKXy8QySRm", /* main-index: 169*/
            "3D828EGfChcinqQeqbFb5TLSUwdnYo1dfX", /* main-index: 170*/
            "3PxLuz6HdV88Lxn3HVyVnnjhC2xdmSKetx", /* main-index: 171*/
            "3Ks8X1w9WHUW5JemRS4HLGZxQM9zRwwkXR", /* main-index: 172*/
            "3JQtuE2YsGeEob7VJ4cQninbpnEKdSJSEV", /* main-index: 173*/
            "3HnLB293NiLB9uKbSNm6UBgJ4fRJQ9EorZ", /* main-index: 174*/
            "3J2xEh8uZvUFedXjPfAM7TsaH5CW3rTZyi", /* main-index: 175*/
            "31s3vQS6rsaMvZVdw8vvrwdTDE2aTvaxRD", /* main-index: 176*/
            "34hXfyWd7nxvZpoZL5oQ49D6f5gv2Mgmi5", /* main-index: 177*/
            "3A2KjgCoRPQoRFGPFAYXALL41XV61qLgTZ", /* main-index: 178*/
            "3Eec4xaDYzqscKn6yHYQcLqn1dQWFARJGD", /* main-index: 179*/
            "34EQdEijpysNa2raQSWmWYkGuqC9HsyBPi", /* main-index: 180*/
            "3BEtieHw9zTbgqQ4SWKY3NgLWKocJQin14", /* main-index: 181*/
            "397LfRVUUv4bPg87bAicX2ZJNjmXAeTsaX", /* main-index: 182*/
            "3CpVtxLuqWahpizQvoL5FagES87eQYMdv1", /* main-index: 183*/
            "3MiWgep6PN9ER6m5Q9M2BF1ue2P8EWoDur", /* main-index: 184*/
            "3QjaTkSjh9wpQeoJQDawuPnYmzBi2cdk8E", /* main-index: 185*/
            "399efdC8i96ty7eSmGz9BY7LeLgqxaJVex", /* main-index: 186*/
            "37TAUMisXVPRSfn5V4zVctMUfShXsN4hb1", /* main-index: 187*/
            "3JUDpkvLQ5H4A9sHErsBZYAD1pqqenjcd3", /* main-index: 188*/
            "3AAKNjncAgDzgdUopt8VSPtSW1pZgMG3bh", /* main-index: 189*/
            "3M3GpeV1zdXrLKuHPkF5dd7hx2hCoPDHHm", /* main-index: 190*/
            "3CjdThLEGY64ae8QSPdXkLdc6PcWmR4uyg", /* main-index: 191*/
            "3Dq5Vpf8vHMyTTqjdvQ8QmdJ1xuDJCHxmH", /* main-index: 192*/
            "39Vp9y8Zs6y3KGsQ1TYGnVpmvxnbtnExrh", /* main-index: 193*/
            "3Eh3ZgdriS2VC7zhFxriwegHZFP5VfKvbf", /* main-index: 194*/
            "37CdPV77gqAeRvhJ6g3A42tCjzRScvaDN6", /* main-index: 195*/
            "38njzLR5e4DmxYdse7nuTNrvX7mB3S1i4D", /* main-index: 196*/
            "3KsjXu34QqmecopuTpijUbjoAKUEfjKr3K", /* main-index: 197*/
            "34kGxzuyqanj9JxySGb7P5CYQAsj5DM866", /* main-index: 198*/
            "3QvkWcatgwx1xtW6gwkESv6cRzRuvgho29", /* main-index: 199*/
            "3F28fn9QbPWUFZe54BPpLAeydWZZrTQSZV", /* main-index: 200*/
            "38ywnbmBA8Zqiw57zNHbcZLZhHrYFe3sGE", /* main-index: 201*/
            "3BoSPyyt64hmty3KXuTezfSFPqPdYkZZ5H", /* main-index: 202*/
            "3LytkmUYQrA9kw9zUECQPN3YnQyCPZ8Zo4", /* main-index: 203*/
            "3QdBFrQ98dCiVAwNnKiunqiJjQKdZscCbb", /* main-index: 204*/
            "35zeh5YrRTv67g6Eb71wvbWLzRBTLtTTQJ", /* main-index: 205*/
            "369wiY66VZvHeTmv2JSCnyNSgQQXxqFcDG", /* main-index: 206*/
            "3J8CH2gJJ9KKQdBPwqcDaSKH6R7yHK1Wrc", /* main-index: 207*/
            "381GBtX7CJktiY9XaXvwgP5FuJtbtmJHeS", /* main-index: 208*/
            "39a3kTwQe6j3yTiC4obVBHsunNeYj2btBU", /* main-index: 209*/
            "3G1EDWEo26qgbANigEHuHaVZLVsgAb14BV", /* main-index: 210*/
            "3DSr5GZWrCyUUX2JFL4DTxd2wHGWfZQ9GD", /* main-index: 211*/
            "3KLFgnN1uJ4DyYch6yX5rtjbiGrPJvW2cx", /* main-index: 212*/
            "3QjrACUhn2KtHCSkcEFk1qSymMDB2YzpFc", /* main-index: 213*/
            "3KE11DMprkJKVzktQtAnqGVaEJf49W2LrW", /* main-index: 214*/
            "3P5nH2fqsiT1a6id2W5h3Ztd3gF2zPMjfh", /* main-index: 215*/
            "3KAd9J9Fotju5BUKxgMNcAvTcWkNEU2THD", /* main-index: 216*/
            "38JGPLA5QaKvT68iwsySrHhvgWo6hcU4wv", /* main-index: 217*/
            "35euaC6WRJpGctAqNA8CY1VXGueysFX43o", /* main-index: 218*/
            "3CVwgKuLJ759fEqEhT2vvRan2z6Kk44sZh", /* main-index: 219*/
            "373qoQnWB2Czgw5uxhjstdTDg5XxJTB517", /* main-index: 220*/
            "39PHUZosWU1dmoX3BLLknQMek39drr4H97", /* main-index: 221*/
            "3MCFLUfeg3hU5D72LRwXTytyfyD7HgKDyV", /* main-index: 222*/
            "3KJg3umjhB4PkQ7SpgpA595EENzR1f8nUg", /* main-index: 223*/
            "3NUKYEAKVDPtRs4m9dzNsJWJv8UfnHoJ1c", /* main-index: 224*/
            "3R1Fq1pcQ8cF3GsBDFfUQNeAA3F32R4nP8", /* main-index: 225*/
            "3LaaRVv9pEuvahAFMh7GYxxzkTczTRovkd", /* main-index: 226*/
            "3GUnM2CJtgFmJYhGmhcSwobpHEFgjG86sU", /* main-index: 227*/
            "3BDwSefYRgJByDmFdpciSQMW2ssxLxfj3H", /* main-index: 228*/
            "3E686878MUybFh41PyboqeUiPwzngpTEPM", /* main-index: 229*/
            "3Et5zaNcFbeQnpqBzwkDaeiMRSDkuc9Gh8", /* main-index: 230*/
            "3FnMhVsk9rk4EgZxsevURdwKdiYWA3Mmmw", /* main-index: 231*/
            "3HFAturVtmQKe37nQdx7V8XhHpoioXbkCz", /* main-index: 232*/
            "3PYHwsDfzFAUsiH62tCzxPKcwD6E2DuiMK", /* main-index: 233*/
            "3BiPHWPCkdREchi3YqG7zULbDDRRMdAXVi", /* main-index: 234*/
            "36ZvRygdAi7iDpBEzfFRSSxAMEFGmXwy3C", /* main-index: 235*/
            "3LXRER8Jd9HVJxB2ozbbs1SFJsPLYsZ7tB", /* main-index: 236*/
            "3F55HwRyhksHseNuJDJd4zaRQajw5N8912", /* main-index: 237*/
            "36vvS9rjLnsocaNH3JMHzp1H4ioAgJdH66", /* main-index: 238*/
            "34qSCUEvhSa9J9uzXN9TaiuRfSwGSAaPnH", /* main-index: 239*/
            "366wHf5Fjo5NWR5jAYGJbPTiz829auez47", /* main-index: 240*/
            "3Hzh8qRXvp7BzJZLWHp2kCxaThgBiitSxH", /* main-index: 241*/
            "36xKdfiCwb4YD8XHgRMDPHuHaS5rDHquJ9", /* main-index: 242*/
            "3PtXzAj8UJYfT9SVJWvBtDdoKozQ5V9Gzx", /* main-index: 243*/
            "34TRXSmup6wV2SKpExd5jHwi548QCvtD34", /* main-index: 244*/
            "3Lx1RBHZWZRbkTQQfhU2eoCUoRJUG2CTfu", /* main-index: 245*/
            "37otJGC1jaGf5ZznuftnUWavMKYHuxStcy", /* main-index: 246*/
            "3Hf2LU8JZVDLQy5KpXfjaHzBc2AYfZMgch", /* main-index: 247*/
            "3MUteP9qMPvLxngqwoHihzzFtamt96eGKg", /* main-index: 248*/
            "31m63dqrMTtmnZiUUtEymEwdoBHcvzSUWN", /* main-index: 249*/
            "3FM18WCSECPxUS3zBRZttDxMJpmnAXo6YY", /* main-index: 250*/
            "34oRKmhgepK9C1BYsbjw3ZaD9bX7SVUeXu", /* main-index: 251*/
            "3HFTKbTFYBPBetdEriBsi8tsdHF5cMnWad", /* main-index: 252*/
            "32rWU7EAdpa6jKtYoz3XTCX2fHe5mnR6q5", /* main-index: 253*/
            "39Fenwocb7veTRhZhFMeBtMBoKnNSksM5V", /* main-index: 254*/
            "3HZhkeTckS9xJCDnYQk5uWc5Hi3EMr7Kr3", /* main-index: 255*/
            "3FtJmjpVBB3AwRgpV7khiT34aRs9Dxiodi", /* main-index: 256*/
            "31ugxYKGQXsofqwnXaft2fZHJPyEWsnvh5", /* main-index: 257*/
            "3PqNm37UuKExZn6XxmLUq6a6U1Bo4FzSuC", /* main-index: 258*/
            "3LR2Yx15V4mj3nTCrYWCRudiwgGSMfVySP", /* main-index: 259*/
            "37nuPE3JnPmF8bAAhwf5atX3xoHezhza3p", /* main-index: 260*/
            "3NG5SU6FnjQQSdC8s6sWBaPUeBivEXBo3s", /* main-index: 261*/
            "3MPZVFZ7JBsnKYQbXqNzVH7u3mVNLLpQVM", /* main-index: 262*/
            "3Dt9zLTJTBoua9Bt667jdpYYgHeFBmVxUs", /* main-index: 263*/
            "32CVTt3Fj8RBqfY8MwPS94UqALG4ncgS2E", /* main-index: 264*/
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        consensus.Hardfork3.Initialize(3 /* Hardfork ID */, 1565128800 /* Hardfork Activation Time */, 100000 /* Hardfork Activation Height - unknown yet */, uint256() /* Hardfork Activation Blockhash - unknown yet*/);
        consensus.nMaxAuxpowBlocks = ~uint32_t(0); // unlimited
        consensus.aPOWAlgos[ALGO_SHA256D]         = CPOWAlgoProperties(ALGO_SHA256D, uint256S("00000000ffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SCRYPT]          = CPOWAlgoProperties(ALGO_SCRYPT, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X11]             = CPOWAlgoProperties(ALGO_X11, uint256S("00000fffff000000000000000000000000000000000000000000000000000000"));
        consensus.aPOWAlgos[ALGO_NEOSCRYPT]       = CPOWAlgoProperties(ALGO_NEOSCRYPT, uint256S("00001fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_EQUIHASH]        = CPOWAlgoProperties(ALGO_EQUIHASH, uint256S("07ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT]        = CPOWAlgoProperties(ALGO_YESCRYPT, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HMQ1725]         = CPOWAlgoProperties(ALGO_HMQ1725, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_XEVAN]           = CPOWAlgoProperties(ALGO_XEVAN, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_NIST5]           = CPOWAlgoProperties(ALGO_NIST5, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_TIMETRAVEL10]    = CPOWAlgoProperties(ALGO_TIMETRAVEL10, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PAWELHASH]       = CPOWAlgoProperties(ALGO_PAWELHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X13]             = CPOWAlgoProperties(ALGO_X13, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X14]             = CPOWAlgoProperties(ALGO_X14, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X15]             = CPOWAlgoProperties(ALGO_X15, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X17]             = CPOWAlgoProperties(ALGO_X17, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2REV2]       = CPOWAlgoProperties(ALGO_LYRA2REV2, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_BLAKE2S]         = CPOWAlgoProperties(ALGO_BLAKE2S, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_BLAKE2B]         = CPOWAlgoProperties(ALGO_BLAKE2B, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ASTRALHASH]      = CPOWAlgoProperties(ALGO_ASTRALHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PADIHASH]        = CPOWAlgoProperties(ALGO_PADIHASH, uint256S("00007fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_JEONGHASH]       = CPOWAlgoProperties(ALGO_JEONGHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ZHASH]           = CPOWAlgoProperties(ALGO_ZHASH, uint256S("07ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_KECCAKC]         = CPOWAlgoProperties(ALGO_KECCAKC, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_GLOBALHASH]      = CPOWAlgoProperties(ALGO_GLOBALHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_QUBIT]           = CPOWAlgoProperties(ALGO_QUBIT, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SKEIN]           = CPOWAlgoProperties(ALGO_SKEIN, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_GROESTL]         = CPOWAlgoProperties(ALGO_GROESTL, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SKUNKHASH]       = CPOWAlgoProperties(ALGO_SKUNKHASH, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_QUARK]           = CPOWAlgoProperties(ALGO_QUARK, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X16R]            = CPOWAlgoProperties(ALGO_X16R, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2REV3]       = CPOWAlgoProperties(ALGO_LYRA2REV3, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R16V2]  = CPOWAlgoProperties(ALGO_YESCRYPT_R16V2, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R24]    = CPOWAlgoProperties(ALGO_YESCRYPT_R24, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R8]     = CPOWAlgoProperties(ALGO_YESCRYPT_R8, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R32]    = CPOWAlgoProperties(ALGO_YESCRYPT_R32, uint256S("0003ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X25X]            = CPOWAlgoProperties(ALGO_X25X, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARGON2D]         = CPOWAlgoProperties(ALGO_ARGON2D, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARGON2I]         = CPOWAlgoProperties(ALGO_ARGON2I, uint256S("0009ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_CPU23R]          = CPOWAlgoProperties(ALGO_CPU23R, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        ...
        consensus.aPOWAlgos[ALGO_LYRA2Z]          = CPOWAlgoProperties(ALGO_LYRA2Z, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HONEYCOMB]       = CPOWAlgoProperties(ALGO_HONEYCOMB, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_EH192]           = CPOWAlgoProperties(ALGO_EH192, uint256S("07ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_MARS]            = CPOWAlgoProperties(ALGO_MARS, uint256S("07ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X12]             = CPOWAlgoProperties(ALGO_X12, uint256S("0000ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HEX]             = CPOWAlgoProperties(ALGO_HEX, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_DEDAL]           = CPOWAlgoProperties(ALGO_DEDAL, ArithToUint256(~arith_uint256(0) >>16));
        consensus.aPOWAlgos[ALGO_C11]             = CPOWAlgoProperties(ALGO_C11, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PHI1612]         = CPOWAlgoProperties(ALGO_PHI1612, ArithToUint256(~arith_uint256(0) >>20));
        consensus.aPOWAlgos[ALGO_PHI2]            = CPOWAlgoProperties(ALGO_PHI2, ArithToUint256(~arith_uint256(0) >>10));
        consensus.aPOWAlgos[ALGO_X16RT]           = CPOWAlgoProperties(ALGO_X16RT, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_TRIBUS]          = CPOWAlgoProperties(ALGO_TRIBUS, ArithToUint256(~arith_uint256(0) >>16));
        consensus.aPOWAlgos[ALGO_ALLIUM]          = CPOWAlgoProperties(ALGO_ALLIUM, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARCTICHASH]      = CPOWAlgoProperties(ALGO_ARCTICHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_DESERTHASH]      = CPOWAlgoProperties(ALGO_DESERTHASH, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_CRYPTOANDCOFFEE] = CPOWAlgoProperties(ALGO_CRYPTOANDCOFFEE, uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
...
public:
    CRegTestParams() {
        ...
        consensus.Hardfork3.Initialize(3 /* Hardfork ID */, 1556661600 /* Hardfork Activation Time */, 100000000 /* Hardfork Activation Height - unknown yet */, uint256() /* there is no hardfork hash for regtest, it will be just activated with the timestamp. */);
        consensus.nMaxAuxpowBlocks = ~uint32_t(0); // unlimited
        consensus.aPOWAlgos[ALGO_SHA256D]         = CPOWAlgoProperties(ALGO_SHA256D, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SCRYPT]          = CPOWAlgoProperties(ALGO_SCRYPT, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X11]             = CPOWAlgoProperties(ALGO_X11, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_NEOSCRYPT]       = CPOWAlgoProperties(ALGO_NEOSCRYPT, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_EQUIHASH]        = CPOWAlgoProperties(ALGO_EQUIHASH, uint256S("0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f"));
        consensus.aPOWAlgos[ALGO_YESCRYPT]        = CPOWAlgoProperties(ALGO_YESCRYPT, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HMQ1725]         = CPOWAlgoProperties(ALGO_HMQ1725, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_XEVAN]           = CPOWAlgoProperties(ALGO_XEVAN, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_NIST5]           = CPOWAlgoProperties(ALGO_NIST5, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_TIMETRAVEL10]    = CPOWAlgoProperties(ALGO_TIMETRAVEL10, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PAWELHASH]       = CPOWAlgoProperties(ALGO_PAWELHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X13]             = CPOWAlgoProperties(ALGO_X13, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X14]             = CPOWAlgoProperties(ALGO_X14, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X15]             = CPOWAlgoProperties(ALGO_X15, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X17]             = CPOWAlgoProperties(ALGO_X17, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2REV2]       = CPOWAlgoProperties(ALGO_LYRA2REV2, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_BLAKE2S]         = CPOWAlgoProperties(ALGO_BLAKE2S, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_BLAKE2B]         = CPOWAlgoProperties(ALGO_BLAKE2B, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ASTRALHASH]      = CPOWAlgoProperties(ALGO_ASTRALHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PADIHASH]        = CPOWAlgoProperties(ALGO_PADIHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_JEONGHASH]       = CPOWAlgoProperties(ALGO_JEONGHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ZHASH]           = CPOWAlgoProperties(ALGO_ZHASH, uint256S("0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f"));
        consensus.aPOWAlgos[ALGO_KECCAKC]         = CPOWAlgoProperties(ALGO_KECCAKC, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_GLOBALHASH]      = CPOWAlgoProperties(ALGO_GLOBALHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_QUBIT]           = CPOWAlgoProperties(ALGO_QUBIT, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SKEIN]           = CPOWAlgoProperties(ALGO_SKEIN, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_GROESTL]         = CPOWAlgoProperties(ALGO_GROESTL, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_SKUNKHASH]       = CPOWAlgoProperties(ALGO_SKUNKHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_QUARK]           = CPOWAlgoProperties(ALGO_QUARK, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X16R]            = CPOWAlgoProperties(ALGO_X16R, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2REV3]       = CPOWAlgoProperties(ALGO_LYRA2REV3, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R16V2]  = CPOWAlgoProperties(ALGO_YESCRYPT_R16V2, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R24]    = CPOWAlgoProperties(ALGO_YESCRYPT_R24, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R8]     = CPOWAlgoProperties(ALGO_YESCRYPT_R8, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESCRYPT_R32]    = CPOWAlgoProperties(ALGO_YESCRYPT_R32, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X25X]            = CPOWAlgoProperties(ALGO_X25X, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARGON2D]         = CPOWAlgoProperties(ALGO_ARGON2D, uint256S("0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARGON2I]         = CPOWAlgoProperties(ALGO_ARGON2I, uint256S("0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_CPU23R]          = CPOWAlgoProperties(ALGO_CPU23R, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_YESPOWER]        = CPOWAlgoProperties(ALGO_YESPOWER, uint256S("3fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X21S]            = CPOWAlgoProperties(ALGO_X21S, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X16S]            = CPOWAlgoProperties(ALGO_X16S, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_X22I]            = CPOWAlgoProperties(ALGO_X22I, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_LYRA2Z]          = CPOWAlgoProperties(ALGO_LYRA2Z, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HONEYCOMB]       = CPOWAlgoProperties(ALGO_HONEYCOMB, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_EH192]           = CPOWAlgoProperties(ALGO_EH192, uint256S("0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f"));
        consensus.aPOWAlgos[ALGO_MARS]            = CPOWAlgoProperties(ALGO_MARS, uint256S("0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f"));
        consensus.aPOWAlgos[ALGO_X12]             = CPOWAlgoProperties(ALGO_X12, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_HEX]             = CPOWAlgoProperties(ALGO_HEX, ArithToUint256(~arith_uint256(0) >>1));
        consensus.aPOWAlgos[ALGO_DEDAL]           = CPOWAlgoProperties(ALGO_DEDAL, ArithToUint256(~arith_uint256(0) >>1));
        consensus.aPOWAlgos[ALGO_C11]             = CPOWAlgoProperties(ALGO_C11, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_PHI1612]         = CPOWAlgoProperties(ALGO_PHI1612, ArithToUint256(~arith_uint256(0) >>1));
        consensus.aPOWAlgos[ALGO_PHI2]            = CPOWAlgoProperties(ALGO_PHI2, ArithToUint256(~arith_uint256(0) >>1));
        consensus.aPOWAlgos[ALGO_X16RT]           = CPOWAlgoProperties(ALGO_X16RT, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_TRIBUS]          = CPOWAlgoProperties(ALGO_TRIBUS, ArithToUint256(~arith_uint256(0) >>1));
        consensus.aPOWAlgos[ALGO_ALLIUM]          = CPOWAlgoProperties(ALGO_ALLIUM, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_ARCTICHASH]      = CPOWAlgoProperties(ALGO_ARCTICHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_DESERTHASH]      = CPOWAlgoProperties(ALGO_DESERTHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_CRYPTOANDCOFFEE] = CPOWAlgoProperties(ALGO_CRYPTOANDCOFFEE, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
        consensus.aPOWAlgos[ALGO_RICKHASH]        = CPOWAlgoProperties(ALGO_RICKHASH, uint256S("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"));
...
std::string CChainParams::GetFoundersRewardAddressAtHeight(int nHeight, bool fUseBridgeAddress) const {
    ...
    int limit = vFoundersRewardAddress.size() - 1;
    
    if(i == 3 && fUseBridgeAddress && NetworkIDString() == "main")
        i++; // Use the next address
...
CScript CChainParams::GetFoundersRewardScriptAtHeight(int nHeight, bool fUseBridgeAddress) const {
    CTxDestination address = DecodeDestination(GetFoundersRewardAddressAtHeight(nHeight, fUseBridgeAddress).c_str());
    assert(IsValidDestination(address));
